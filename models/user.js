...
const emailValidator=[
    {
        validator:emailLengthChecker,message:'Email must be 5 characters long but not more than 40 characters!'
    },
    {
  ...
  const passwordValidators = [
    {
      ...
      message: 'Password should be of length more than 8 and less than 35.'
    },
    {
